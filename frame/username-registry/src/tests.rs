...
fn registration_and_unregistration_should_work() {
    new_test_ext().execute_with(|| {
        ...
        assert_ok!(UsernameRegistry::register(Origin::signed(4), b"foo".to_vec(), 0));
        assert_noop!(
        ...
        assert_eq!(
            ...
            Some(Registration { judgements: vec![(0, Judgement::Requested)], account_id: 4 }),
        );
        assert_noop!(
        ...
        assert_ok!(UsernameRegistry::unregister(Origin::signed(4), b"foo".to_vec()));
        assert_eq!(UsernameRegistry::registration_of(b"foo".to_vec()), None);
    });
}
...
fn killing_username_should_work() {
    new_test_ext().execute_with(|| {
        ...
        assert_ok!(UsernameRegistry::kill_username(Origin::signed(2), b"foo".to_vec()));
        assert_eq!(UsernameRegistry::registration_of(b"foo".to_vec()), None);
    });
}
...
fn providing_judgement_should_work() {
    new_test_ext().execute_with(|| {
        ...
        assert_noop!(
            UsernameRegistry::provide_judgement(Origin::signed(4), 0, b"foo".to_vec(), Judgement::Approved),
            Error::<Test>::InvalidIndex,
        );
        assert_noop!(
            UsernameRegistry::provide_judgement(Origin::signed(5), 0, b"foo".to_vec(), Judgement::Approved),
            Error::<Test>::InvalidIndex,
        );
        assert_ok!(UsernameRegistry::provide_judgement(Origin::signed(3), 0, b"foo".to_vec(), Judgement::Approved));
        assert_ok!(UsernameRegistry::provide_judgement(Origin::signed(4), 1, b"foo".to_vec(), Judgement::Approved));
        assert_eq!(
            UsernameRegistry::registration_of(b"foo".to_vec()),
            Some(Registration { judgements: vec![(0, Judgement::Approved), (1, Judgement::Approved)], account_id: 4 }),
        );
    });
}
...
fn registration_and_unregistration_with_invalid_username_should_not_work() {
    new_test_ext().execute_with(|| {
        ...
        assert_ok!(UsernameRegistry::register(Origin::signed(4), b"123".to_vec(), 0));
        assert_eq!(
        ...
        assert_ok!(UsernameRegistry::unregister(Origin::signed(4), b"123".to_vec()));
        assert_eq!(UsernameRegistry::registration_of(b"123".to_vec()), None);
    });
}
