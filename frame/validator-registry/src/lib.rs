...
use frame_support::{decl_module, decl_storage, decl_event, decl_error, dispatch, ensure, traits::Get, Parameter};
...
impl<T: Trait> Module<T> {
    fn validate_mission_id(mission_id: T::MissionId) -> dispatch::DispatchResult {
        ensure!(mission_id > 0.into() && mission_id < 13.into(), Error::<T>::InvalidMissionId);
