...
https://github.com/social-network/node/blob/master/core/primitives/src/crypto.rs#L767[here], but the
...
https://github.com/social-network/node/blob/master/LICENSE[LICENSE]
